...
def generate_signature(api_key: str, api_secret: str, params: Dict[str, Any] = None) -> Dict[str, str]:
    """
...
def verify_signature(api_key: str, api_secret: str, received_signature: str, params: Dict[str, Any]) -> bool:
    """
...
def is_api_key_valid(connection_manager: ConnectionManager, api_key: str, api_secret: str) -> bool:
    """
