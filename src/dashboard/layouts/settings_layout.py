        ...
        dbc.CardBody([
            dbc.Row([
                dbc.Col([
                    ...
                    html.Div(id="position-size-output", className="slider-output"),
                ], md=6),
                dbc.Col([
                    ...
                    html.Div(id="max-drawdown-output", className="slider-output"),
                ], md=6),
            ]),
            html.Hr(),
            dbc.Row([
                dbc.Col([
                    ...
                    dbc.Input(id="default-leverage-input", type="number", value=2),
                ], md=3),
                dbc.Col([
                    dbc.Label("Max Open Positions"),
                    dbc.Input(id="max-positions-input", type="number", value=5),
                ], md=3),
                dbc.Col([
                    dbc.Label("Stop Loss (ATR Multiplier)"),
                    dbc.Input(id="stop-loss-atr-input", type="number", value=2.0),
                ], md=3),
                dbc.Col([
                    dbc.Label("Risk/Reward Ratio"),
                    dbc.Input(id="risk-reward-input", type="number", value=2.0),
                ], md=3),
            ]),
            html.Hr(),
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    dbc.Input(id="circuit-breaker-input", type="number", value=3),
                ], md=6),
            ]),
            html.Hr(),
            dbc.Button(
