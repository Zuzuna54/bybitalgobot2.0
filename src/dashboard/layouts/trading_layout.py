                                        ...
                                        [
                                            ...
                                            dbc.CardBody(
                                                [
                                                    dbc.Button(
                                                        "Start Trading",
                                                        id="start-system-button",
                                                        color="success",
                                                        className="me-2",
                                                    ),
                                                    dbc.Button(
                                                        "Pause Trading",
                                                        id="pause-system-button",
                                                        color="warning",
                                                        className="me-2",
                                                    ),
                                                    dbc.Button(
                                                        "Stop Trading",
                                                        id="stop-system-button",
                                                        color="danger",
                                                    ),
                                                ]
                                            ),
                                        ...
                                        [
                                            ...
                                            dbc.CardBody(
                                                [
                                                    ...
                                                    html.Div(
                                                        "Manual trading is disabled in this version",
...
def register_trading_callbacks(
    ...
    """
    logger.debug("Registering trading layout callbacks")
